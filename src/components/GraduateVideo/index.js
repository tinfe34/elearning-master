...
export default class GraduateVideo extends Component {
  render() {
    return (
      <section className="graduate">
        <div className="container">
          ...
          <div className="row">
            <div className="col-12 col-md-6">
              <div className="graduate__video mb-3">
                <img src={video1} width="100%" height="auto" />
                <div className="graduate__video-icon">
                  <i
        ...
        <div className="graduate__contact">
          <div className="container">
            <div className="row">
              <div className="col-12 col-md-6">
