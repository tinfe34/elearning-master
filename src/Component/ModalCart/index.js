          ...
          {arrayCourseCart.map((course, index) => {
            return (
              <tr key={index}>
                <td>{index + 1}</td>
                <td>
                  <img width={100} height={70} src={course.hinhAnh} />
                </td>
                ...
                <td>
                  <button
                    ...
                    onClick={() => this.removeToCart(course.maKhoaHoc)}
                  >
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              {arrayCourseCart.length ? (
                this.renderTable(arrayCourseCart)
              ) : (
                <div className="text-center">
                  <h5 className="text-dark">
                    Không Có Khóa học nào ,hãy mua sắm ngay nào!!!
                  </h5>
